...
def create_conversation(session:SessionDep, conversation_id:str,user_id:str|uuid.UUID):
...
def create_ticket_conversation(session:SessionDep, last_message_id:int, ticket:Tickets):
